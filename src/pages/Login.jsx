        ...
        <div className="w-screen h-screen bg-[#ffffff] flex flex-col justify-center items-center">
            <div className="px-auto md:bg-[#f7f8f9] h-[96vh] md:h-[89vh] flex flex-col justify-start py-10 md:px-5">
                ...
                <form className="flex flex-col mt-8">
                    ...
                    <button onClick={(e) => { e.preventDefault(); setEmail(""); setPassword(""); navigate("/account") }} disabled={!password || !email} className={` ${password && email ? ' bg-[#6c25ff] active:scale-95 hover:bg-[#5125ffc2]' : ' bg-[#3130312c]'} text-[#ffffff] px-19 py-[11.5px] text-[15px] rounded-md mb-8 border-none font-medium tracking-normal cursor-pointer   transition-all duration-300`}>Login</button>
                </form>
